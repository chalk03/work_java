...
public class BoardController {
	...
	public void menuAdd() {
		...
		/*
		 * id가 null값인 이유는 Service에서 id값을 생성하기 때문에 regDate가 null값인 이유는 Controller는 화면관련
		 * 클래스이기 때문에 regDate의 초기화는 Service 클래스에 맡긴다.
		 */ // 7.
	...
	public void menuModify() {
		...
		/*
		 * writer: 변경되지 않기 때문에 null regDate: 변경되지 않기 때문에 null
		 */ // 8.
